...
import { createTrainingWeekController } from '@/presentation/http/controllers/training-week/create-training-week'
import { getAllTrainingWeeksController } from '@/presentation/http/controllers/training-week/get-all-training-weeks'
import { getTrainingWeekByIdController } from '@/presentation/http/controllers/training-week/get-training-week-by-id'
import { updateTrainingWeekController } from '@/presentation/http/controllers/training-week/update-training-week'
import { deleteTrainingWeekController } from '@/presentation/http/controllers/training-week/delete-training-week'
