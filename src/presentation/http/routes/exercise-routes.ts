...
import { createExerciseController } from '@/presentation/http/controllers/exercise/create';
import { updateExerciseController } from '@/presentation/http/controllers/exercise/update';
import { deleteExerciseController } from '@/presentation/http/controllers/exercise/delete';
import { markExerciseAsDoneController } from '@/presentation/http/controllers/exercise/markExerciseAsDoneController';
